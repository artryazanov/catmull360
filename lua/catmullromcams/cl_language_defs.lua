language.Add("Tool.catmullrom_camera.name", "Catmull-Rom CC 360°: Track Layout")
...
language.Add("Tool.catmullrom_camera_numpad_trigger.name", "Catmull-Rom CC 360°: Numpad Trigger Editor")
...
language.Add("Tool.catmullrom_camera_looker.name", "Catmull-Rom CC 360°: Smart Look Modifier")
...
language.Add("Tool.catmullrom_camera_map_io.name", "Catmull-Rom CC 360°: Map I/O Modifier")
...
language.Add("Tool.catmullrom_camera_linker.name", "Catmull-Rom CC 360°: Track Linker")
...
language.Add("Tool.catmullrom_camera_hitchcock.name", "Catmull-Rom CC 360°: Hitchcock Effect")
